 ...
 */
public class FateCustomCellWriteHandler implements CellWriteHandler {

    /**
     * 生成的Excel表格的第9列
     */
    private static final Integer COLUMN_INDEX = 4;

    /**
     * 测试第六列，给其状态值 异常设置为红色
     */
    private static final Integer FATE_COLUMN_INDEX = 5;
    /**
     * 有效期的区间数字_60
     */
